...
const FAQSection: NextPage = () => {
  return (
    <section className="self-stretch bg-white-200 flex flex-col p-[100px] items-center justify-center text-center text-2xs text-darkslategray-200 font-josefin-sans">
      <div className="self-stretch flex flex-col items-center justify-start gap-[50px]">
        ...
        <div className="self-stretch flex flex-col py-0 px-[90px] items-center justify-center gap-[37px] text-left text-base text-mediumslateblue font-poppins">
