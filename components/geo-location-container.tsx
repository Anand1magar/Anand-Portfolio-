...
const GeoLocationContainer: NextPage = () => {
  return (
    <div className="self-stretch bg-darkslategray-200 flex flex-col pt-[100px] px-[100px] pb-12 items-center justify-center gap-[40px] text-left text-2xs text-white-200 font-josefin-sans">
      <div className="self-stretch flex flex-row items-start justify-between max-w-[1240px] md:flex-col md:gap-[100px] md:items-start md:justify-center">
        ...
        <div className="flex flex-col items-start justify-start gap-[30px] text-right">
          ...
          <div className="relative w-[259px] h-[105px] shrink-0 text-left text-base text-burlywood-100">
            <div className="absolute top-[0px] left-[-0.82px] flex flex-col items-start justify-start gap-[5px]">
              <div className="relative tracking-[0.2px] leading-[30px]">
                <span>Mon – Fri:</span>
