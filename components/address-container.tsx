...
const AddressContainer: NextPage = () => {
  return (
    <div className="self-stretch bg-white-200 flex flex-row p-[100px] items-center justify-center text-left text-4xl text-darkslategray-200 font-cormorant-infant">
      <div className="self-stretch flex-1 flex flex-row items-center justify-start gap-[150px] max-w-[1240px] md:flex-col md:gap-[5px]">
        <div className="flex-1 flex flex-col items-start justify-start gap-[71px] md:flex-[unset] md:self-stretch">
          ...
          <div className="flex flex-col items-start justify-start gap-[28px] text-sm text-hytenocolor-text1 font-inter">
            <div className="w-[382.5px] flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-row items-start justify-between">
                <div className="relative tracking-[0.48px] leading-[26.36px] font-medium">
                  <span>SUNDAY - FRIDAY</span>
                  <span className="text-black"> :</span>
                </div>
                <div className="w-[193.5px] shrink-0 flex flex-col items-start justify-start gap-[2px] text-black">
            ...
            <div className="w-[382.5px] flex flex-col items-start justify-start">
              <div className="self-stretch flex flex-row items-start justify-between">
                ...
                <div className="w-[194.09px] shrink-0 flex flex-col items-start justify-start gap-[2px] text-black">
                  <div className="relative tracking-[0.48px] leading-[26.36px] font-semibold">
                    6:30 PM - 11:00 PM
                  </div>
                  <div className="relative text-xs tracking-[0.48px] leading-[26.36px] text-gray-21">
        ...
        <div className="self-stretch flex-1 flex flex-col items-center justify-start md:flex-[unset] md:self-stretch">
          <div className="self-stretch flex-1 relative">
            <img
              className="absolute top-[0px] left-[0px] w-[545px] h-[307px] object-cover"
              alt=""
